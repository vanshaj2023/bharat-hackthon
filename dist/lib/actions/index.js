...
function scrapeAndStoreProduct(productUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var scrapedProduct, product, existingProduct, updatedPriceHistory, newProduct, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 7, , 8]);
                    return [4 /*yield*/, (0, mongoose_1.connectToDB)()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, scraper_1.scrapeAmazonProduct)(productUrl)];
                case 3:
                    scrapedProduct = _a.sent();
                    if (!scrapedProduct)
                        return [2 /*return*/];
                    product = scrapedProduct;
                    return [4 /*yield*/, product_model_1.default.findOne({ url: scrapedProduct.url })];
                case 4:
                    existingProduct = _a.sent();
                    if (existingProduct) {
                        updatedPriceHistory = __spreadArray(__spreadArray([], existingProduct.priceHistory, true), [
                    ...
                    return [4 /*yield*/, product_model_1.default.findOneAndUpdate({ url: scrapedProduct.url }, product, { upsert: true, new: true })];
                case 5:
                    newProduct = _a.sent();
                    return [4 /*yield*/, (0, cache_1.revalidatePath)("/products/".concat(newProduct._id))];
                case 6:
                    _a.sent();
                    return [3 /*break*/, 8];
                case 7:
                    error_1 = _a.sent();
                    throw new Error("Failed to create/update product: ".concat(error_1.message));
...
function getSimilarProducts(productId) {
    return __awaiter(this, void 0, void 0, function () {
        var currentProduct, similarProducts, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 3:
                    similarProducts = _a.sent();
                    return [2 /*return*/, similarProducts];
                case 4:
                    error_4 = _a.sent();
                    console.log(error_4);
                    return [3 /*break*/, 5];
...
function addUserEmailToProduct(productId, userEmail) {
    return __awaiter(this, void 0, void 0, function () {
        var product, userExists, emailContent, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                ...
                case 1:
                    ...
                    if (!product)
                        return [2 /*return*/];
                    userExists = product.users.some(function (user) { return user.email === userEmail; });
                    if (!!userExists) return [3 /*break*/, 5];
                    product.users.push({ email: userEmail });
                    return [4 /*yield*/, product.save()];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, (0, nodemailer_1.generateEmailBody)(product, "WELCOME")];
                case 3:
